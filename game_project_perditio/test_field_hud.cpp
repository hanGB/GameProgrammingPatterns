...
TestFieldHud::TestFieldHud(UiElementPool* uiElementPool)
{
	...
	ProgressBar* bodyBar = dynamic_cast<ProgressBar*>(m_uiElementPool->PopElement(PERUiElementType::PROGRESS_BAR));
	...
	ProgressBar* mindBar = dynamic_cast<ProgressBar*>(m_uiElementPool->PopElement(PERUiElementType::PROGRESS_BAR));
